  ...
  return (
    <article className="min-w-min rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
        ...
        <div className="relative flex items-end overflow-hidden rounded-xl">
            ...
            <div className="flex items-center space-x-1.5 rounded-lg bg-indigo-500 px-4 py-1.5 text-white duration-100 hover:bg-indigo-600">
        ...
        <div className="mt-1 p-2">
            ...
            <div className="mt-3 flex items-end justify-between">
                <p className="text-lg font-bold text-indigo-500">$850</p>
